...
import { X, DoorOpen, Beaker, Tag, FileText, Activity } from 'lucide-react';
...
export default function CreateSalaModal({ isOpen, onClose, onCreated }: CreateSalaModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // TODO: Ajustar endpoint cuando exista la ruta de salas en el backend
            await api.post('/createSala', {
            ...
            const msg = error.response?.data?.message || 'Error al crear el módulo';
            alert(msg);
            console.error(error);
        } finally {
                            ...
                            <div className="flex items-center gap-2.5">
                                ...
                                <div>
                                    ...
                                    <p className="text-[11px] text-gray-500">
                                        Registra un nuevo módulo en el laboratorio
                                    </p>
                                </div>
                            </div>
                            <button

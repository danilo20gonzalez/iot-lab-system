...
import LabModal from '../components/CULab';
            ...
            <div>
                <div className="max-w-7xl mx-auto p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
                        <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-200 hover:-translate-y-2 hover:shadow-md transition-all duration-200 cursor-pointer">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center flex-shrink-0">
                                    <Building2 className="text-blue-600" size={20} />
                                </div>
                                <div>
                                    <p className="text-xs font-medium text-gray-600">Total Laboratorios</p>
                        ...
                        <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-200 hover:-translate-y-2 hover:shadow-md transition-all duration-200 cursor-pointer">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-xs font-medium text-gray-600">Sensores Activos</p>
                                    <p className="text-xl font-bold text-gray-900">{stats.totalSensors}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-200 hover:-translate-y-2 hover:shadow-md transition-all duration-200 cursor-pointer">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-xs font-medium text-gray-600">Usuarios Asociados</p>
                        ...
                        <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-200 hover:-translate-y-2 hover:shadow-md transition-all duration-200 cursor-pointer">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-xs font-medium text-gray-600">Automatizados</p>
                                    <p className="text-xl font-bold text-gray-900">{stats.automated}</p>
                                </div>
                            </div>
                        </div>
                    </div>
